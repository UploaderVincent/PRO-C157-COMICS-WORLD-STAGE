AFRAME.registerComponent("info-banner", {
  ...
  update: function () {
    //TASK 🙂
    //call createBanner() here as this.createBanner();
    this.createBanner()
  ...
  createBanner: function () {
    ...
    //TASK 🙂
    // select this id in querySelector -> #fadeBackground
    ...
    //TASK 🙂
    //append entityEl to fadeBackgroundEl in the next statement
    entityEl.fadeBackgroundEl
